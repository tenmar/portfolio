...
class Experience extends React.Component<IExperienceProps> {
  ...
  renderNav() {
    return <button disabled={this.props.camera.isAtCenter()} className="back-button" onClick={(evt: any) => { this.props.camera.backToCenter() }}>A</button>
  }

  render() {
    return <div className="experience" style={{ flexDirection: 'column', width: 550 }}>
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center'}}><h1 style={{ flex: 1 }}>Experience</h1></div>
